...
def file_index_json_contents_bottom(metadata_build_dir, verilog_build_dir, \
        package_build_json_dependencies = ['\"/scratch/ericc/work/make_fed_test/builds/coreip_e31_fcd/memgen/CoreIPSubsystemAmbaAllPortRAMTestHarness.SiFiveCoreDesignerAlterations.rams.json\"', "null"]):
